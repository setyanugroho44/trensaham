    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Akun {tierLabel} maksimal {MAX_SYMBOLS} kode saham. Paste beberapa kode saham pisahkan dengan spasi, koma, atau baris baru. Disarankan isi &gt; 25 saham.</CardDescription>
        </CardHeader>
